...
longest fossil range (35.55 Ma)
    ...
    ##        genus            species  minage  maxage
    ## 1   Panthera    Panthera tigris 0.00585 1.68450
    ## 2    Caracal     Caracal serval 0.00585 3.09400
    ## 3 Pratifelis Pratifelis martini 7.60000 7.60000
    ## 4      Felis       Felis youngi 1.29985 1.29985
    ## 5       Lynx  Lynx longignathus 7.60000 7.60000
...
The figure shows the fossil records for felines. There are 139 unique
species records and 34 unique genera. Cynodictis lacustris has the
longest fossil range (35.55 Ma). *Miracinonyx inexpectatus* has the
longest fossil range (13.28 Ma)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-3-1.png)

    occGenus<-taxonSortPBDBocc(graptOccPBDB, rank="genus")
    #plot it!
    plotOccData(occGenus)

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-3-2.png)

    #taxicDivDisc with the retiolinae dataset
    data(retiolitinae)
    taxicDivDisc(retioRanges)

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-3-3.png)
...
---------------------------------
    ...
    ## 1 Krishna Krishnamurthy            0      FALSE
    ## 2   Irina          Bird           14       TRUE
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-2.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-3.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-4.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-5.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-6.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-7.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-8.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-9.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-10.png)

    # Challenge 2
    ggplot(data = gapminder, aes(x = year, y = lifeExp, color=continent)) +
      geom_point()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-11.png)

    # Challenge 3
    ggplot(data = gapminder, aes(x=year, y=lifeExp, by=country)) +
     geom_point() + geom_line(aes(color=continent)) # point appears under the line

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-12.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-13.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-14.png)

    # Challenge 5
    ggplot(data = gapminder, aes(x = gdpPercap, fill=continent)) +
     geom_density(alpha=0.6) + facet_wrap( ~ year) + scale_x_log10()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-8-15.png)
